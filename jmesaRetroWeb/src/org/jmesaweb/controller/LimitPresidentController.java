...
public class LimitPresidentController extends AbstractController {
    ...
    protected String render(HttpServletRequest request, HttpServletResponse response) {
        ...
        tableFacade.setColumnProperties(new String[]{"name.firstName", "name.lastName", "term", "career"}); // define the column properties
        tableFacade.setExportTypes(response, new ExportType[]{ExportType.CSV, ExportType.EXCEL}); // Tell the tableFacade what exports to use.
