...
public class BasicPresidentController extends AbstractController {
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        tableFacade.setExportTypes(response, new ExportType[]{ExportType.CSV, ExportType.JEXCEL, ExportType.PDFP}); // set the exports allowed
    ...
    private void export(TableFacade tableFacade) {
        // set the column properties
        tableFacade.setColumnProperties(new String[]{"name.firstName", "name.lastName", "term", "career"});
