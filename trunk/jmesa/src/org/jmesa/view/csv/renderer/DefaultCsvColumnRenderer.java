 ...
 */
public class DefaultCsvColumnRenderer extends AbstractColumnRenderer implements CsvColumnRenderer {
	private String delimiter;

	public DefaultCsvColumnRenderer(Column column, ColumnEditor editor) {
		setColumn(column);
