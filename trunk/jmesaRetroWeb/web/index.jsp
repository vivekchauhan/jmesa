...
<html>
  ...
  <body>
    ...
    <p class="content" style="font-weight: bold;">
      A new table library written from scratch to be an API.
    </p>
    ...
    <p class="content">
      ...
      <a href="<c:url value="/presidents.run"/>">examples</a>.
    </p>

    <p>
      <a href="<c:url value="/presidents.run"/>">
        <img src="<c:url value="/images/jmesa-2.2.gif"/>" alt="JMesa"/>
      </a>
    </p>
